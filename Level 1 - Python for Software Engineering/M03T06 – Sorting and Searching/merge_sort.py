...
# Example usage:
example_list = ["once", "upon", "a", "time", "the", "elephant", "tumbled", "down", "the", "stairs"]
example_list2 = ["the", "elephant", "was", "soooooooo", "sad", "but", "then", "a", "mouse", "saved", "it"]
example_list3 = ["the", "mouse", "went", "don't", "woooorrryyyy", "life", "is", "very", "incredibly", "beautiful"]
